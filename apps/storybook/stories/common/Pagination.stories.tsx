...
const meta: Meta<typeof Pagination> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "A pagination component for navigating through multiple pages of content with customizable page sizes and navigation controls.",
      },
    },
  },
  tags: ["autodocs"],
        ...
        <div className="text-center">
          ...
          <div className="p-8 bg-gray-50 rounded-lg">
            <p className="text-gray-600">
              This is the content for article {currentPage}. Lorem ipsum dolor sit amet, 
