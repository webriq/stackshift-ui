...
const displayName = "NavigationMenu";
const displayNameList = "NavigationMenuList";
const displayNameItem = "NavigationMenuItem";
const displayNameTrigger = "NavigationMenuTrigger";
const displayNameContent = "NavigationMenuContent";
const displayNameLink = "NavigationMenuLink";
const displayNameIndicator = "NavigationMenuIndicator";
const displayNameViewport = "NavigationMenuViewport";
